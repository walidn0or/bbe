  ...
  const newsArticles = [
    {
      ...
      excerpt:
        "Beyond Borders Empowerment is pleased to host a Chevening Information Session on the fully funded UK government scholarship that offers exceptional future leaders the opportunity to pursue a world-class education in the UK. In this session, expert Chevening alumni will guide participants through the eligibility criteria, application tips and essay writing guidance, as well as the opportunities and benefits of the program. Don't miss this chance to learn directly from alumni and take your first step toward a fully funded master's degree in the UK.",
      image: newsImages[1],
      date: "2025",
    ...
    },
    {
      ...
      excerpt:
        "In February 2025, Beyond Borders Empowerment (BBE) hosted a Refugees Cultural Event at Rumi Restaurant in London, bringing together refugees and community members from diverse backgrounds for an evening of connection and solidarity. The event created a valuable space for networking, shared experiences, and mutual understanding, while also expressing collective support for girls and women in Afghanistan. During the gathering, BBE officially launched its 'Pathways Towards Opportunities' program, an initiative designed to equip young Afghan girls and women with English language and computer skills to support their education and future opportunities. More than 100 participants attended the event, demonstrating a strong sense of community commitment and shared responsibility.",
      image: newsImages[2],
      date: "February 2025",
      ...
      views: "3.8K",
      likes: 287,
      tags: ["Cultural Event", "London", "Refugees", "Community"],
      fullContent: "In February 2025, Beyond Borders Empowerment (BBE) hosted a Refugees Cultural Event at Rumi Restaurant in London, bringing together refugees and community members from diverse backgrounds for an evening of connection and solidarity. The event created a valuable space for networking, shared experiences, and mutual understanding, while also expressing collective support for girls and women in Afghanistan. During the gathering, BBE officially launched its 'Pathways Towards Opportunities' program, an initiative designed to equip young Afghan girls and women with English language and computer skills to support their education and future opportunities. More than 100 participants attended the event, demonstrating a strong sense of community commitment and shared responsibility. The evening highlighted the urgent need to address educational gaps in Afghanistan and reinforced the importance of collective action in supporting access to learning and empowerment.",
    },
    {
      id: 3,
      title: "Psychological First Aid (PFA) Training",
      excerpt:
        "Beyond Borders Empowerment is pleased to announce the launch of an Online Training on Psychological First Aid (PFA) delivered by expert dear Rahila Poya. This program aims to strengthen the capacity of individuals and communities to respond to emotional and psychological distress during times of crisis. This virtual training is designed for professionals, volunteers, and community members who wish to support individuals affected by stress, trauma, disasters, or emergencies.",
      image: newsImages[3],
      date: "December 2024",
      ...
      views: "2.9K",
      likes: 234,
      tags: ["PFA", "Mental Health", "Training", "Crisis Support"],
      fullContent: "Beyond Borders Empowerment is pleased to announce the launch of an Online Training on Psychological First Aid (PFA) delivered by expert dear Rahila Poya. This program aims to strengthen the capacity of individuals and communities to respond to emotional and psychological distress during times of crisis. This virtual training is designed for professionals, volunteers, and community members who wish to support individuals affected by stress, trauma, disasters, or emergencies. The sessions will be delivered in a safe, interactive, and professional online learning environment, ensuring accessibility for participants across different locations. The training will cover key aspects of Psychological First Aid, including: Understanding the core principles and steps of PFA, Recognizing common signs of stress and trauma, Providing immediate emotional and practical support, Knowing how and when to refer individuals to specialized mental health services. Through this program, participants will gain practical, hands-on knowledge to respond with compassion, confidence, and effectiveness in challenging situations. The training also aims to promote community resilience and mental well-being, particularly in contexts affected by ongoing uncertainty and crisis. Training Details: Dates: December 27, 28, and 29 | Time: 6:00 PM – 7:00 PM (Kabul Time) | Format: Online (Google Meet) | Trainer: Rahila Poya",
    },
  ]
